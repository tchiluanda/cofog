...
Em sua maioria, os nomes são aparentemente autoexplicativos, como é o caso da Proteção Social, responsável pelo segundo maior parte do gasto do governo federal em 2022. Outras vezes, o título pode ser mais amplo, a exemplo de Serviços Públicos em geral, em que um olhar superficial pode não revelar a melhor informação. A única opção é entrar no labirinto.

Se o governo federal tivesse um gasto total de R\$ 100 em 2022, cerca de R\$ 80,40 estariam alocados nessas duas categorias: Proteção Social e Serviços Públicos em geral. Se observarmos a sequência de valores para essas duas categorias entre 2019 e 2022, podemos ver como o impacto da pandemia mexeu nas posições de liderança. Em 2020 os gastos com proteção social ultrapassaram o de Serviços Públicos em geral ficando nessa posição também em 2021. Já em 2022 com a vota gradual à normalidade, há redução dos gastos de governo com assitência social e um forte aumento om pagamento de Juros, o que levou a nova inversão das posições entre os dois primeiors colocados.

Voltando a 2022, todas as outras 8 áreas de atuação do governo federal dividiriam os R\$ 19,66 restantes. Aqui novamente há reversão da trajetória da pandemia influenciando o reposicionamento das despesas com saúde e educação. Desse grupo, a Educação receberia R\$ 6,95, sendo R\$ 2,28 gastos com a educação superior, enquanto outros R\$ 4,11 seriam principlamente transferidos aos estados e municípiospara serem gastos com os primeiros níveis de ensino. A Saúde, destino de R\$ 5,86 do total de R\$ 100, tem uma dinâmica parecida, pois se transfere a maior parte desse recurso para ser executado pelos governos regionais, justificado pela responsabilidade do governo central em organizar e financiar o Sistema Único de Saúde (SUS). Minotauro quase derrotado. Aqui vale destacar novamente o impacto da pandemia. Esse ano é a segunda vez que Saúde ultrapassa Educação nos gastos do governo central.

Diante dos R\$ 7,15 que ainda restariam, Ordem Pública e Segurança, bem como Defesa, reuniriam mais da metade, ou seja R\$ 4,32. Já a área Assuntos Econômicos, responsável por temas relacionados à combustível e energia, agricultura, pesca, dentre outras atividades econômicas, receberia R\$ 2,09. Sobraria um pouco menos de um real para as demais três funções. Portanto, se o gasto total fosse R\$ 100, setenta e quatro centavos seriam divididos por Habitação e Serviços Comunitários, Proteção Ambiental e Lazer, Cultura e Religião. O fio leva à saída do labirinto.
...
Nas próximas sessões o fio de Ariadne é melhor detalhado. Apresentamos aqui as três sessões do aplicativo que explora os dados seguindo a padronização internacional definida pela Classificação por Função de Governo da OCDE/ONU (COFOG ‐ Classification of Functions of Government). [^1]

[^1]: Até o final de Outubro de 2021 os dados brutos do COFOG serão atualizados após um trabalho em conjunto com o IBGE. Em seguida, depois de alguns dias, essas atualizações serão refletidas nesta aplicação
